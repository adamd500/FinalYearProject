...
public class EmploymentStatusInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employment_status_info);
        ...
        webview.loadUrl("https://www.revenue.ie/en/self-assessment-and-self-employment/construction-industry/are-you-self-employed-or-an-employee.aspx");
