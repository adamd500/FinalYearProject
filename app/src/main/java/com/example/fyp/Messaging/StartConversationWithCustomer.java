...
public class StartConversationWithCustomer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_conversation_with_customer);
    ...
    public void backToListing(View v){
        Intent intent=new Intent(this,SelectedNewJob.class);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot child : children) {
                    if (child.getKey().equals(customerId)) {
                        ...
                        titleText.setText("Listing Title : " + title + "\n Customer Name : " + customer.getName() + "\n");
                    }
                }
            }
