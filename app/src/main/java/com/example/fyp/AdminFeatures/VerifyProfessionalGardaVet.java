...
public class VerifyProfessionalGardaVet extends AppCompatActivity {
    private TextView t1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verify_professional_garda_vet);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot child : children) {
                    if (child.getKey().equals(professionalId)) {
                        ...
                        storageReference1 = storage.getReferenceFromUrl("gs://fypdatabase-d9dfe.appspot.com" + professional.getGardaVetImage());
                        ...
                        try {
                            ...
                            storageReference1.getFile(file1).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(VerifyProfessionalGardaVet.this, "Image Failed to Load", Toast.LENGTH_SHORT).show();
                                }
                            });
                        } catch (IOException e) {
                            e.printStackTrace();
    ...
    public void verifyGardaVetForm(View view) {
        ref.child("Professional").child(professionalId).child("gardaVetVer").setValue(true);
