...
import com.example.fyp.CustomerFeatures.SelectedKeywordJob;
...
public class JobKeywordAdapter extends RecyclerView.Adapter<JobKeywordAdapter.MyViewHolder>{
...
public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public JobKeywordAdapter(ArrayList<Job> myDataset){
        jobsFromDb =myDataset;
    }
    @Override
    public JobKeywordAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        //create new view - create a row - inflate the layout for the row
        LayoutInflater inflater= LayoutInflater.from(parent.getContext());
        View itemView =inflater.inflate(R.layout.job_keyword_recycler,parent,false);
        JobKeywordAdapter.MyViewHolder viewHolder=new JobKeywordAdapter.MyViewHolder(itemView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull JobKeywordAdapter.MyViewHolder holder, int position) {
        ...
        holder.t2.setText(String.valueOf(name.getPrice()));
        holder.t3.setText(name.getActualDuration());
        holder.t5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(v.getContext(), SelectedKeywordJob.class);
