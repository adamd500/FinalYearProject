...
public class ProfessionalUploadGardaVet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_professional_upload_garda_vet);
    ...
    public void uploadImage(View v) {
        if (filePath != null) {
            ...
            StorageReference ref = storageReference.child("gardaVetFiles/"+name+" gardaVetForm");
            picPath = ref.getPath();
            ref.putFile(filePath)
                    .addOnSuccessListener(
                            new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    dbRef.child("Professional").child(uid).child("gardaVetImage").setValue(picPath);

                                    Toast.makeText(ProfessionalUploadGardaVet.this, "Image Uploaded!!", Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(ProfessionalUploadGardaVet.this, ProfessionalProfile.class);
                                    startActivity(intent);
                                }
                            })
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            progressDialog.dismiss();
                            Toast.makeText(ProfessionalUploadGardaVet.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
